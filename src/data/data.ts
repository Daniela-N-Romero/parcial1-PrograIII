...
export const PRODUCTS: Product[] = [
  {
    ...
    stock: 20,
    imagen: "/products-imgs/pizza-1.png",
    disponible: true,
  ...
  },
  {
    ...
    stock: 15,
    imagen: "/products-imgs/pizza-2.png",
    disponible: true,
    categorias: [categorias[0]],
  },
  {
    ...
    stock: 10,
    imagen: "/products-imgs/pizza-3.png",
    disponible: true,
    categorias: [categorias[0]],
  },
  {
    ...
    stock: 30,
    imagen: "/products-imgs/burger-1.jfif",
    disponible: true,
  ...
  },
  {
    ...
    stock: 25,
    imagen: "/products-imgs/burger-2.jfif",
    disponible: true,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 0,
    imagen: "/products-imgs/burger-3.jfif",
    disponible: false,
    categorias: [categorias[1]],
  },
  {
    ...
    stock: 100,
    imagen: "/products-imgs/beverage-1.jfif",
    disponible: true,
  ...
  },
  {
    ...
    stock: 40,
    imagen: "/products-imgs/beverage-2.jfif",
    disponible: true,
    categorias: [categorias[2]],
  },
  {
    ...
    stock: 150,
    imagen: "/products-imgs/beverage-3.jfif",
    disponible: true,
    categorias: [categorias[2]],
  },
  {
    ...
    stock: 12,
    imagen: "/products-imgs/dessert-1.png",
    disponible: true,
  ...
  },
  {
    ...
    stock: 30,
    imagen: "/products-imgs/dessert-2.png",
    disponible: true,
    categorias: [categorias[3]],
  },
  {
    ...
    stock: 0,
    imagen: "/products-imgs/dessert-3.png",
    disponible: false,
    categorias: [categorias[3]],
  },
  {
    ...
    stock: 50,
    imagen: "/products-imgs/empanadas-1.png",
    disponible: true,
  ...
  },
  {
    ...
    stock: 45,
    imagen: "/products-imgs/empanadas-2.png",
    disponible: true,
    categorias: [categorias[4]],
  },
  {
    ...
    stock: 60,
    imagen: "/products-imgs/empanadas-3.png",
    disponible: true,
    categorias: [categorias[4]],
  },
  {
    ...
    stock: 20,
    imagen: "/products-imgs/ensalada-1.png",
    disponible: true,
  ...
  },
  {
    ...
    stock: 18,
    imagen: "/products-imgs/ensalada-2.png",
    disponible: true,
    categorias: [categorias[5]],
  },
  {
